...
If you discover a security vulnerability in a third-party dependency used by jf-pushover-webhook, please report it directly to the maintainers of that module. You can also notify us through our security advisory process so we can:
